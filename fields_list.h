...
struct field main_list[] = {
  ...
  {FIELD_SELECTION, 48, 0, 48, 48,  TFT_BLACK, "MODE", "USB", "USB/LSB/CW/CWR/FT8/FT4/AM/DIGI/2TONE"},
  ...
  {FIELD_KEY, 120, 280, 48, 40,  TFT_BLACK, "-", "-"},
  ...
  {FIELD_SELECTION, 336, 272, 48, 48,  TFT_BLACK, "TX_CQ", "EVEN", "EVEN/ODD"},
  {FIELD_SELECTION, 384, 272, 48, 48,  TFT_BLACK, "AUTO", "ON", "OFF/ON/CQ Alt/xOTA"},
  ...
  /* settings */
  {FIELD_STATIC, 12, 72, 110, 0, TFT_BLACK, "MY CALL", "MY CALL:", "0/10"},
  {FIELD_TEXT, 8, 84, 110, 24, TFT_BLACK, "MYCALLSIGN", "", "0/10"},
  {FIELD_STATIC, 130, 72, 110, 0, TFT_BLACK, "MY GRID", "MY GRID:", "0/10"},
  {FIELD_TEXT, 126, 84, 110, 24, TFT_BLACK, "MYGRID", "", "0/10"},
  {FIELD_STATIC, 248, 72, 110, 0, TFT_BLACK, "PASS KEY", "PASS KEY:", "0/10"},
  {FIELD_TEXT, 244, 84, 110, 24, TFT_BLACK, "PASSKEY", "", "0/10"},
  {FIELD_SELECTION, 362, 34, 110, 48, TFT_BLACK, "xOTA", "", "NONE/IOTA/SOTA/POTA"},
  {FIELD_TEXT, 362, 84, 110, 24, TFT_BLACK, "LOCATION", "", "0/16"},
  {FIELD_SELECTION, 8, 128, 110, 48, TFT_BLACK, "CW_INPUT", "", "IAMBIC/IAMBICB/STRAIGHT"},
  {FIELD_NUMBER, 126, 128, 110, 48, TFT_BLACK, "CW_DELAY", "300", "50/1000/50"},
  {FIELD_NUMBER, 244, 128, 110, 48,  TFT_BLACK, "SIDETONE", "80", "0/100/5"},
  {FIELD_SELECTION, 362, 128, 110, 48, TFT_BLACK, "MACRO", "", "FT8/SOTA/CW1/CQWWRUN/RUN/SP"},
